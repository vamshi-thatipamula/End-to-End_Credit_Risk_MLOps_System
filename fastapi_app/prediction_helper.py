...
dagshub.init(
    repo_owner="vamshi-thatipamula",
    repo_name="End-to-End_Credit_Risk_MLOps_System",
    mlflow=True
)
...
saved_objects = joblib.load(ARTIFACT_PATH)
...
# ==============================================================================
# Load Champion Model from DagsHub MLflow
# ==============================================================================

MODEL_URI = "models:/Credit Risk Model@champion"
